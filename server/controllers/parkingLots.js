...
const ParkingSlot = require('../models/ParkingSlot.js')
const User = require('../models/User.js')
const dayjs = require('dayjs')
const { postParkingValidator, getParkingValidator, bookSlotValidator } = require('../validators/joi-validator.js')
const mongoose = require('mongoose')
const axios = require('axios')
const sendEmail = require('../Utils/sendEmail.js')
const sendEmail2 = require('../Utils/sendEmail2.js')
    ...
    try{
        ...
        */
        ...
        if (freeParkingLots.length === 0) {
            return res.status(404).json({msg:"No parking slots nearby!",freeParkingLots:freeParkingLots})
        } else {
            return res.status(200).json({msg: `${freeParkingLots.length} Parking Slot Found Nearby`,freeParkingLots:freeParkingLots})
        }
    }catch(err){
        console.log(err)
        return res.status(500).json({msg:"Something went wrong.."})
